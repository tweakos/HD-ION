...
static int msm_ion_rotator_size;
...
static void __init size_ion_devices(void)
{
        ...
        msm_ion_rotator_size = MSM_ION_ROTATOR_SIZE;
        
        ion_pdata.heaps[1].size = msm_ion_audio_size;
        ion_pdata.heaps[2].size = msm_ion_rotator_size;
